...
with __stickytape_temporary_dir() as __stickytape_working_dir:
    ...
    __stickytape_write_module('func2.py', b'# import numpy as np\nimport os\nimport json\n\n\ndef function(serwoObject) -> dict:\n    # NOTE - assuming that the body here will be in bytes or string\n    body = json.loads(serwoObject.get_body())\n    num = int(body["val"])\n    print("This is function 2")\n    return {"val": str(num**3)}')
    import importlib
    import json
    import sys
    import func2 as user_function
